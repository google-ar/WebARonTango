...
unsigned CardboardVRDevice::GetMaxPointCloudVertexCount()
{
  return 0;
}

VRPointCloudPtr CardboardVRDevice::GetPointCloud(bool justUpdatePointCloud, unsigned pointsToSkip)
{
  return nullptr;
}

VRSeeThroughCameraPtr CardboardVRDevice::GetSeeThroughCamera()
{
  return nullptr;
}

VRPickingPointAndPlanePtr CardboardVRDevice::GetPickingPointAndPlaneInPointCloud(float x, float y)
{
  return nullptr;
}

mojo::Array<float> CardboardVRDevice::GetPoseMatrix()
{
  return nullptr;
}
