...
void WebGL2RenderingContextBase::texImage2D(GLenum target, GLint level, GLint internalformat, GLenum format, GLenum type, VRSeeThroughCamera* seeThroughCamera)
{
    WebGLRenderingContextBase::texImage2D(target, level, internalformat, format, type, seeThroughCamera);
}
